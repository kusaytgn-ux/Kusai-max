...
const CLUB_PRIVILEGES: Record<string, string[]> = {
  "MAX MEMBER": [
    "100 000 бонусов на 1 год\nОплачивайте бонусами до:\n30% стоймости аксесуаров;\n3% стоймости техники;\n10% стоймости услуг.",
    "ГЛЦ-Гарантия лучшей цены\nНашли выгоднее-оброщайтесь к менеджеру, сделает индивидуальное предложение.",
    "KUSAI Консьерж\nНапишите нам в приложении KUSAI MAX, что хотите купить-мы помжем подобрать технику под ваши задачи и бюджет.",
    "Техника под заказ\nДоступ к расширенному каталогу техники с доставкой большинства позиций от 1 дня.",
    "Trade-In\nПредварительная оценка устройства прямо в приложении, а так же онлайн + возможность сдать старое устройство в зачет нового.",
    "KUSAI SELECT\nДоступ к специальным предложениям, акциям и товарам недели внутри Mini App.",
  ],

  "MAX SILVER": [
    "Все из MAX MEMBER+",
    "До 40% выгоды на аксесуары\nДо 30% бонусами + дополнительная скидка до 10% для SILVER.",
    "+5% к оценке Trade-In\nПовышенная оценка относительно стандартного предложения КУСАЙ.",
    "Бесплатная доставка\nПо Таганрогу при заказе от 5 000 ₽.",
    "Бесплатная настройка при покупке устройства\nПеренос данных, учетнаязапись и первичная настройка нового устройства.",
    "SILVER-предложения\nПерсональный раздел в Mini App со специальными ценами и предложениями только для SILVER и выше.",
  ],

  "MAX GOLD": [
    "Все из MAX SILVER+",
    "До 50% выгоды на аксесуары\nДо 30% бонусами + дополнительная скидка до 20% для GOLD.",
    "+10% к оценке Trade-In\nПовышенная оценка относительно стандартного предложения КУСАЙ.",
    "GOLD Консьерж\nНапишите нам в приложении или в мсенджерах MAX или Telegram: Нужен робот-пылесос до 50 000 ₽-мы сами найдем подходящие варианты и организуем покупку",
    "Бесплатная доставка\nПо Таганрогу без минимальной суммы заказа.",
    "Приоритет на дефицитные товары\nGOLD-клеинты получают преимущество при резервировании ограниченных поставок и новых устройств.",
    "Расширенная настройка при покупке устройства\nПеренос данных, полная настройка устройства и установка доступных удаленных приложений.",
    "Сервис без очереди\nПриоритетная диагностика и экспресс-ремонт при вас, если характер ремонта это позволяет.",
    "Ранний доступ\nПриоритетная регистрация на мероприятия, презентации и специальные запуски КУСАЙ.",
    "Бонус к дню рождения\nПерсональный подарок или дополнительные бонусы.",
  ],
  ...
  "MAX BLACK": [
    ...
    "Персональные подарки\nПодарки при крупных покупках и особых событиях.",
    "BLACK Birthday\nОтдельный персональный подарок ко дню рождения.",
    "Семейные привелегии\nВозможность распростронять часть преимуществ BLACK на членов семьи.",
  ],
};
                        ...
                        {CLUB_PRIVILEGES[level.name].map(
                          (privilege) => (
                            ...
                            >
                              ...
                              <span className="whitespace-pre-line text-sm text-zinc-300">
                                {privilege}
                              </span>
                            </div>
                          )
